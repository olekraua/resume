...
public class EditProfileController {
    ...
    public String saveProfile(@PathVariable String uid, @Valid @ModelAttribute("form") ProfileMainForm form,
        ...
        profileService.updateInfo(profileId, editProfileService.toInfoForm(form));
        profileService.updateContacts(profileId, editProfileService.toContactsForm(form));
    ...
    private String prepareProfileMain(String uid, Model model) {
        ...
        ProfileMainForm form = editProfileService.toProfileMainForm(profile);
        model.addAttribute("profile", profile);
        model.addAttribute("form", form);
        return "edit/profile";
    }
    ...
    private Object formFromProfile(Object emptyForm, Profile profile) {
        return editProfileService.formFromProfile(emptyForm, profile);
    }
}
