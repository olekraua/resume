...
--
-- Name: remember_me_token; Type: TABLE; Schema: public; Owner: resume
--
...
ALTER TABLE public.remember_me_token OWNER TO resume;
...
4	olekraua	Олександр	Кравченко	1993-05-23	+41765246710	ksanya7@gmail.com	Ukraine	Pyriatyn	Java Applikationsentwickler	Akutell beschäftige ich mit einer App-Entwicklung.	/uploads/photos/b7da7442-950c-4e4c-bd85-955411b10695.jpg	/uploads/photos/b7da7442-950c-4e4c-bd85-955411b10695-sm.jpg	\N	$2a$10$khQsZor/sLv4EAQyjNo6g.qmIGeJ8jR/DSO3nk.YOYzbCYuTlWK5e	t	2025-12-06 19:07:05	\N	\N	\N	\N
\.
...
COPY public.remember_me_token (series, token, last_used, profile_id) FROM stdin;
xfIJKBhW4w+kqskoxH0++g==	sPxKbCUcxykgnJMFTnkq6Q==	2026-01-21 23:14:28.054+01	4
\.
...
9	4	Tools	Visual Studio Code, Docker
10	4	Build system	Maven
11	4	Frameworks	Spring
\.
...
SELECT pg_catalog.setval('public.skill_seq', 11, true);
...
--
-- Name: remember_me_token remember_me_token_pkey; Type: CONSTRAINT; Schema: public; Owner: resume
--
...
--
-- Name: idx_remember_me_profile; Type: INDEX; Schema: public; Owner: resume
--
...
--
-- Name: remember_me_token fk_remember_me_profile; Type: FK CONSTRAINT; Schema: public; Owner: resume
--
