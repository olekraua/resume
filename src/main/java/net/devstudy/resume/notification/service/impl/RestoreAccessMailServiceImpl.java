package net.devstudy.resume.notification.service.impl;
...
import net.devstudy.resume.notification.component.TemplateResolver;
import net.devstudy.resume.notification.config.RestoreMailTemplateProperties;
